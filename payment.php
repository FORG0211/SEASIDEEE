...
$stmt_check = $pdo->prepare("SELECT COUNT(*) FROM payments WHERE order_id = ?");
$stmt_check->execute([$reservation_id]);
$existing_payment = $stmt_check->fetchColumn();
...
<div class="container">
    ...
    <form method="POST" action="payment.php" class="payment-form">
        ...
        <div class="form-group">
            <button type="submit" name="payment_method" value="paypal" style="background-color: #049ff8; border-color: #444;">Proceed with GCash</button>
        </div>
    </form>
    <div class="form-group">
         <a href="reservation.php" class="button-link" style="background-color: #046cf8; border-color: #444;">Back to Reservation</a>
    </div>
</div>
